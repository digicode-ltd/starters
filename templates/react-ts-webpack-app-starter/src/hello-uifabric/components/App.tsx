...
import { Stack, Text, Link, FontWeights, PrimaryButton, DefaultButton } from 'office-ui-fabric-react';
...
export const App: React.FunctionComponent = () => {
  return (
    <Stack
      ...
      gap={15}
    >
      <PrimaryButton iconProps={{ iconName: 'Read' }}>Hello World</PrimaryButton>
